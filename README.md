...
- Leaflet Map  https://chenlocker.github.io/leaflet-maps-with-google-sheets/
- Google Sheets template https://docs.google.com/spreadsheets/d/1YVzwU-mLCRP_vjvyQxGl56IlaG-dEOziXXumaSpVYbE/edit#gid=0
...
With the original code shared by [Ilya Ilyankou](https://github.com/ilyankou) and [Jack Dougherty](https://github.com/jackdougherty), this interactive map is initial contributed by Mengqi (Archie) Chen (https://github.com/chenlocker).
